...
class TimelineViewModel(
    ...
    override fun reduce(intent: TimelineMviModel.Intent) {
        when (intent) {
            ...
            is TimelineMviModel.Intent.ToggleReblog -> toggleReblog(intent.entryId)
            is TimelineMviModel.Intent.ToggleFavorite -> toggleFavorite(intent.entryId)
            is TimelineMviModel.Intent.ToggleBookmark -> toggleBookmark(intent.entryId)
        }
    }
