...
sealed interface ApiCredentials {
    data class HttpBasic(val user: String, val pass: String) : ApiCredentials

    data class OAuth2(val accessToken: String, val refreshToken: String) : ApiCredentials
}

internal fun ApiCredentials.toServiceCredentials() = when (this) {
