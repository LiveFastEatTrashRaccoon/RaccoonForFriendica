...
class DefaultAccountRepositoryTest {
    ...
    @Test
    fun `given existing accounts when getAll then result is as expected`() = runTest {
        val entities =
            (0..<2).map {
    ...
    @Test
    fun `given no accounts when getAll then result is as expected`() = runTest {
    ...
    @Test
    fun `given existing accounts when getAllAsFlow then result is as expected`() = runTest {
        val entities =
            flowOf(
                (0..<2).map {
                    AccountEntity(id = it.toLong(), handle = "account$it@example.org")
    ...
    @Test
    fun `given existing account when getBy ID then result is as expected`() = runTest {
        val id = 1L
    ...
    @Test
    fun `given existing account when getBy handle then result is as expected`() = runTest {
        val handle = "account1@example.org"
    ...
    @Test
    fun `given currently account when getActive then result is as expected`() = runTest {
    ...
    @Test
    fun `given no active account when getActive then result is as expected`() = runTest {
    ...
    @Test
    fun `given currently account when getActiveAsFlow then result is as expected`() = runTest {
    ...
    @Test
    fun `when create then interactions are as expected`() = runTest {
        val account =
    ...
    @Test
    fun `when delete then interactions are as expected`() = runTest {
        val account =
            AccountModel(id = 1, handle = "account1@example.org")
        sut.delete(account)
    ...
    @Test
    fun `given currently account when setActive true then interactions is as expected`() = runTest {
        everySuspend { accountDao.getActive() } returns
            AccountEntity(id = 1, handle = "account1@example.org", active = true)
        val account =
    ...
    @Test
    fun `given currently account when setActive false then interactions is as expected`() = runTest {
        everySuspend { accountDao.getActive() } returns
            AccountEntity(id = 1, handle = "account1@example.org", active = true)
        val account =
            AccountModel(id = 1, handle = "account1@example.org")
    ...
    @Test
    fun `given no active account when setActive true then interactions is as expected`() = runTest {
        everySuspend { accountDao.getActive() } returns null
        val account =
            AccountModel(id = 1, handle = "account1@example.org")
    ...
    @Test
    fun `given no active account when setActive false then interactions is as expected`() = runTest {
        everySuspend { accountDao.getActive() } returns null
        val account =
            AccountModel(id = 1, handle = "account1@example.org")
