...
class DefaultEmojiRepositoryTest {
    ...
    @Test
    fun `given error when getAll then result is as expected`() = runTest {
    ...
    @Test
    fun `given results and cache miss when getAll on local instance then result is as expected`() = runTest {
        val list =
            listOf(
                CustomEmoji(
                    shortCode = "",
    ...
    @Test
    fun `given results and cache hit when getAll on local instance then result is as expected`() = runTest {
        val list =
            listOf(
                CustomEmoji(
                    shortCode = "",
    ...
    @Test
    fun `given results when getAll on local instance twice then result is as expected`() = runTest {
        val list =
            listOf(
                CustomEmoji(
                    shortCode = "",
    ...
    @Test
    fun `given results when getAll on local instance twice refreshing then result is as expected`() = runTest {
        val list =
            listOf(
                CustomEmoji(
                    shortCode = "",
    ...
    @Test
    fun `given results and cache miss when getAll on other instance then result is as expected`() = runTest {
        val list =
            listOf(
                CustomEmoji(
                    shortCode = "",
    ...
    @Test
    fun `given results and cache hit when getAll on other instance then result is as expected`() = runTest {
        val list =
            listOf(
                CustomEmoji(
                    shortCode = "",
    ...
    @Test
    fun `given results when getAll on other instance twice then result is as expected`() = runTest {
        val list =
            listOf(
                CustomEmoji(
                    shortCode = "",
    ...
    @Test
    fun `given results when getAll on other instance twice refreshing then result is as expected`() = runTest {
        val list =
            listOf(
                CustomEmoji(
                    shortCode = "",
