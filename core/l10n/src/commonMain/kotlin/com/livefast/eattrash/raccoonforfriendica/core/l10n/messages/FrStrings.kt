...
internal val FrStrings =
    object : DefaultStrings() {
        ...
        override val actionGoBack = "Revenir en arrière"
        override val actionOpenOptions = "Options"
        override val actionAddReaction = "Ajouter une réaction"
        override val actionShowContentDescription = "Afficher la description"
        override val actionReblog = "Partager"
        override val actionToggleReveal = "Afficher la visibilité"
        override val actionOpenFullScreen = "Ouvrir en plein écran"
        override val actionSubmit = "Soumettre"
        override val actionChangeVisibility = "Modifier la visibilité"
        override val actionSave = "Sauvegarder"
        override val actionReply = "Répondre"
        override val actionSelect = "Sélectionner la valeur"
        override val actionOpenSideMenu = "Ouvrir le menu latéral"
        override val actionOpenDetail = "Ouvrir le détail"
        override val actionOpenLink = "Ouvrir le lien"
        override val actionClear = "Effacer"
        override val actionSearch = "Rechercher"
        override val actionFilter = "Filtrer"
        override val actionAddToBookmarks = "Ajouter aux signets"
        override val actionAddToFavorites = "Ajouter aux favoris"
        override val actionDownload = "Télécharger"
        override val actionInsertLink = "Insérer un lien"
        override val verifiedField = "vérifié"
        override val updateDate = "date de mise à jour"
        override val creationDate = "date de création"
        override val likesCount = "aimés"
        override val dislikesCount = "pas aimés"
        override val highestScore = "meilleur score"
        override val formatBold = "Gras"
        override val formatItalic = "Italique"
